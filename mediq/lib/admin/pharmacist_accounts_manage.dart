...
class PharmacistAccountsManagePage extends StatelessWidget {
  const PharmacistAccountsManagePage({super.key});
...
class _UserListScreenState extends State<UserListScreen> {
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        key: const PageStorageKey('pharmacist_list'),
                  ...
                  children: [
                    Expanded(
                      child: _buildModernActionButton(
                        ...
                        Icons.check_circle,
                        status == 'Approved',
                        status == 'Approved' ? null : () => _updateStatus(userId, 'Approved'),
                      ),
                    ),
  ...
  // ----- Updated Action Button (horizontal) -----
  ...
  // Edit Dialog with modern input decoration
  ...
  Future<void> _deleteUser(String userId) async {
    try {
      ...
      _showSnackBar('Pharmacist deleted successfully', true);
    } catch (e) {
      _showSnackBar('Failed to delete pharmacist: $e', false);
    }
  }
