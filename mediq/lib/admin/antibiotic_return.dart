...
class ReturnReleasesScreen extends StatefulWidget {
  const ReturnReleasesScreen({super.key});

  @override
  State<ReturnReleasesScreen> createState() => _ReturnReleasesScreenState();
}

class _ReturnReleasesScreenState extends State<ReturnReleasesScreen> {
  ...
  // ---- Modern Return Card (with edit/delete buttons) ----
