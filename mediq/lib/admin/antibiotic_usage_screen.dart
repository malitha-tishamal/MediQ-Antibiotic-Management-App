...
class AntibioticUsageScreen extends StatefulWidget {
  const AntibioticUsageScreen({super.key});

  @override
  State<AntibioticUsageScreen> createState() => _AntibioticUsageScreenState();
}

class _AntibioticUsageScreenState extends State<AntibioticUsageScreen> {
